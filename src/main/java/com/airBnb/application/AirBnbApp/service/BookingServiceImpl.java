...
import com.airBnb.application.AirBnbApp.entity.*;
import com.airBnb.application.AirBnbApp.entity.enums.BookingStatus;
import com.airBnb.application.AirBnbApp.exception.ResourceNotFoundException;
import com.airBnb.application.AirBnbApp.exception.UnAuthorisedException;
import com.airBnb.application.AirBnbApp.repository.*;
import com.airBnb.application.AirBnbApp.strategy.PricingService;
...
import static com.airBnb.application.AirBnbApp.util.AppUtils.getCurrentUser;
...
public class BookingServiceImpl implements BookingService{
    ...
    public void capturePayment(Event event) {
        if ("checkout.session.completed".equals(event.getType())) {
            ...
            if (session == null || session.getId() == null) {
                throw new ResourceNotFoundException("Session is not found");
            }
    ...
    public void cancelBooking(Long bookingId) {
        ...
        try {
            ...
            log.info("Refund Successfully Completed with Booking Id : {}",bookingId) ;
